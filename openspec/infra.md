...
> Last verified: 2026-08-03 · Script: `scripts/verify-infra.sh`
>
...
Automatic non-draft `pull_request` review (deterministic blocking + advisory LLM). Operation: [`doc/automated-pr-review.md`](../doc/automated-pr-review.md) (hub operator page). Canonical guide §2.19 copy is an archive follow-up. Disabling the workflow or its authentication leaves `sdd-gates` and manual review skills usable.
