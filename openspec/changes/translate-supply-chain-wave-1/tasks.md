...
- [ ] 1.1 Translate `openspec/changes/add-supply-chain-gates/proposal.md` to glossary-canonical English in-place
...
- [ ] 1.2 Translate `openspec/changes/add-supply-chain-gates/tasks.md` to glossary-canonical English in-place (keep historical `[x]` markers and Gate/Pattern command strings structurally intact)
...
- [ ] 1.3 Translate `openspec/changes/add-supply-chain-gates/specs/sdd-ci-gates/spec.md` to glossary-canonical English in-place
