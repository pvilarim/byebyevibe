...
Live GitHub Actions URLs wait for a non-draft same-repository PR after `ready_for_review` (the workflow skips drafts by design). Canonical guide §2.19 insertion is an archive follow-up; the hub operator page is `doc/automated-pr-review.md`.
