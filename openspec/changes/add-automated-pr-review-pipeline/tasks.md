...
- [ ] 4.1 Complete the semantic review matrix from `design.md`, run strict OpenSpec/task/release-readiness checks, and execute one controlled same-repository PR before declaring the issue resolved.
