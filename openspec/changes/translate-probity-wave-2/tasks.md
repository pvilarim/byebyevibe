...
- [ ] 1.1 Translate `openspec/changes/add-probity-tdd-module/design.md` to glossary-canonical English in-place (keep decision IDs D1–D10, A–E matrix labels, package pin, rule identifiers, and fenced commands structurally intact)
