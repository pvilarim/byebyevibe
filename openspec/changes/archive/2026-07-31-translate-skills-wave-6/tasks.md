...
- [x] 2.2 Sync `.claude/skills/openspec-propose/SKILL.md` to match the Cursor mirror exactly (same English content)
...
- [x] 3.2 Validate OpenSpec change + task Pattern paths
  ...
  - **Gate:** `bash scripts/verify-task-patterns.sh && OPENSPEC_TELEMETRY=0 npx --yes @fission-ai/openspec@1.3.1 validate translate-skills-wave-6 --strict`
