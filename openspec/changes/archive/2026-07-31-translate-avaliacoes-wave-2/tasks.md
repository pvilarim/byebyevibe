...
- [x] 2.2 Rewrite `doc/avaliacoes/2026-06-27-sdd-ui-development-module.md` Portuguese prose → glossary-canonical English; keep UI-module **Adopted** outcome, pointers to §2.11 / design docs, Impeccable `--yes` confirmation semantics, and phase-risk table meaning; do not soften Adopted into Deferred
