...
- [x] 1.1 Criar `doc/avaliacoes/2026-06-27-sdd-ui-development-module.md` (avaliação agregada Impeccable + OD + Pencil)
...
- [x] 1.2 Actualizar índice `doc/avaliacoes/README.md` com entrada do módulo UI
  - **Pattern:** `doc/avaliacoes/README.md` (tabela índice Headroom)
  - **Gate:** `grep -q 'sdd-ui-development-module' doc/avaliacoes/README.md`

- [x] 1.3 Adicionar nota no topo de `doc/design/000-*` e `doc/design/001-*`: shadcn = caminho default; ver `003`
...
- [x] 2.1 Criar `doc/design/002-ui-module-install.md` — C1-UI, árvore shadcn, checklist, conflito skills, mitigações M1–M7
...
- [x] 2.2 Criar `doc/design/003-ui-stack-adapters.md` — Caminho B (tailwind-custom) e C (other)
...
- [x] 3.1 Implementar `sdd-kit/install-ui-module.sh` com `--detect`, `--dry-run`, `--apply`, `--yes`
...
- [x] 3.2 Lógica `--detect`: `components.json` / `components/ui/` → shadcn; tailwind sem ui → prompt path
...
- [x] 3.3 `--apply`: copiar `doc/design/*` do templates; Impeccable só com `--yes`; actualizar `infra.md`
  - **Pattern:** `sdd-kit/install.sh`
...
- [x] 4.1 Copiar `doc/design/000–003` para `sdd-kit/templates/doc/design/`
...
- [x] 4.2 Actualizar `sdd-kit/MANIFEST.yaml` com `install-ui-module.sh` e quatro `doc/design/*`
...
- [x] 5.3 Criar §2.11.1 checklist verificação UI module
  - **Pattern:** `doc/sistema-sdd-pedro.md` §2.8
  - **Gate:** `grep -q '2.11.1' doc/sistema-sdd-pedro.md`

- [x] 5.4 Criar §5.6 referências cruzadas módulo UI
...
- [x] 5.5 Bump changelog guia (v1.3.1 ou v1.4.0) com entrada UI module
...
- [x] 6.1 Secção UI Development Module em `openspec/infra.md` e template kit
  - **Pattern:** `openspec/infra.md` secção Install Kit
  - **Gate:** `grep -q 'UI Development Module\|Módulo.*UI' openspec/infra.md`

- [x] 6.2 Campo `UI stack:` no template `openspec/project.md` (§12.1) e `sdd-kit/templates/`
...
- [x] 6.3 Ponteiros UI em `sdd-kit/templates/AGENTS.core.md` Contexto sob demanda (se ≤150 linhas após merge)
...
- [x] 6.4 Cross-references em `openspec/project.md` para §2.11 e `doc/design/`
  - **Pattern:** `openspec/project.md` Cross-references
  - **Gate:** `grep -q 'doc/design' openspec/project.md`

## 7. Spec normativa e validação

- [x] 7.1 Promover `openspec/changes/add-sdd-ui-development-module/specs/sdd-ui-module/spec.md` para `openspec/specs/` no archive
...
- [x] 7.2 Correr `scripts/verify-task-patterns.sh` no `tasks.md` deste change
  - **Pattern:** `scripts/verify-task-patterns.sh`
  - **Gate:** `bash scripts/verify-task-patterns.sh openspec/changes/add-sdd-ui-development-module/tasks.md`

- [x] 7.3 Validar change: `npx openspec validate add-sdd-ui-development-module` (se CLI disponível)
