# Design — translate-guide-wave-6

## Context

- Layer-1 policy: `sdd-docs-language` / `doc/i18n/*`.
- Target: `doc/sistema-sdd-pedro.md` lines **840–1046** (§2.9 SDD upgrade procedure, ~207 LOC).
...
**Chosen:** Lines 840–1046 only; whole-file path in gate (G-PT scans entire file — prior slices must be apply-complete).
...
1. Apply EN substitution for lines 840–1046.
2. Gate: `bash scripts/verify-i18n-wave.sh --files doc/sistema-sdd-pedro.md`.
3. Validate: `OPENSPEC_TELEMETRY=0 npx --yes @fission-ai/openspec@1.3.1 validate translate-guide-wave-6 --strict`.
