...
- [x] 1.1 Translate `openspec/changes/add-supply-chain-gates/design.md` to glossary-canonical English in-place (keep decision IDs D1–D9, G1 compatibility table IDs, SHA pins, and fenced commands structurally intact)
