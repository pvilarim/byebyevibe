# Design — translate-kit-design-wave-3

## Context

- Layer-1 policy: `sdd-docs-language` / `doc/i18n/*`.
- Target: `sdd-kit/templates/doc/design/001-pipeline-open-design-shadcn-impeccable.md` lines **1–325** (kit mirror §1–§3.4, ~325 LOC).
...
3. Validate: `OPENSPEC_TELEMETRY=0 npx --yes @fission-ai/openspec@1.3.1 validate translate-kit-design-wave-3 --strict`.
