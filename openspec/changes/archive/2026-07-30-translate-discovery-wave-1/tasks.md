...
- [x] 1.1 Translate `openspec/changes/add-sdd-discovery-positioning/proposal.md` to glossary-canonical English in-place
...
- [x] 1.2 Translate `openspec/changes/add-sdd-discovery-positioning/design.md` to glossary-canonical English in-place
...
- [x] 1.3 Translate `openspec/changes/add-sdd-discovery-positioning/tasks.md` to glossary-canonical English in-place (keep historical `[x]` markers and Gate/Pattern command strings structurally intact)
