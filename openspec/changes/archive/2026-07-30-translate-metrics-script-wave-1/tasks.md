...
- [x] 1.1 Translate `openspec/changes/add-sdd-metrics-script/proposal.md` to glossary-canonical English in-place
...
- [x] 1.2 Translate `openspec/changes/add-sdd-metrics-script/design.md` to glossary-canonical English in-place
...
- [x] 1.3 Translate `openspec/changes/add-sdd-metrics-script/tasks.md` to glossary-canonical English in-place (keep historical `[x]` markers and Gate/Pattern command strings structurally intact)
