# sdd-post-install-verification

Requisitos para verificação pós-instalação do sistema SDD (OpenSpec + GitNexus + Graphify + AGENTS.md), alinhados a `doc/sistema-sdd-pedro.md` §2.8.
