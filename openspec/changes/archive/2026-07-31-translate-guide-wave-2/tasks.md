...
- [x] 2.1 Rewrite lines **133–297** (§2.0b–2.4 install core (OpenSpec, GitNexus, Graphify)) Portuguese prose → glossary-canonical English; do not edit lines outside the slice
  - **Pattern:** `doc/sistema-sdd-pedro.md`
  - **Gate:** `bash scripts/verify-i18n-wave.sh --files doc/sistema-sdd-pedro.md --slice 133-297`
