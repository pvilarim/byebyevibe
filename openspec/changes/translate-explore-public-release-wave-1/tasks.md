...
- [ ] 1.1 Confirm glossary covers terms needed for this wave (`evaluation`, Adopted/Deferred/Discarded, wave, glossary, Session Handoff, fail-closed); append rows to `doc/i18n/GLOSSARY.md` only if a new SDD term is introduced (same PR)
