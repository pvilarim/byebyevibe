...
- [ ] 2.1 Rewrite lines **1–325** (§1–§3.4 pipeline overview through DESIGN.md schema) Portuguese prose → glossary-canonical English; do not edit lines outside the slice
