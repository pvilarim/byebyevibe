...
- [ ] 1.2 Soft-check hub design-wave-2 apply status and avoid concurrent kit-template applies
...
- [ ] 3.1 Regenerate kit MANIFEST checksums after template edits and verify kit integrity
...
- [ ] 3.2 Run per-wave i18n verification on the exact kit design file
