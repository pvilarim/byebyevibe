...
- [ ] 1.1 Translate `openspec/changes/add-sdd-metrics-cadence-nudge/proposal.md` to glossary-canonical English in-place
...
- [ ] 1.2 Translate `openspec/changes/add-sdd-metrics-cadence-nudge/design.md` to glossary-canonical English in-place
...
- [ ] 1.3 Translate `openspec/changes/add-sdd-metrics-cadence-nudge/tasks.md` to glossary-canonical English in-place (keep historical `[x]` markers and Gate/Pattern command strings structurally intact)
