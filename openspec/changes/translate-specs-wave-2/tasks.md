...
- [ ] 1.1 Confirm glossary covers terms needed for this wave (`install kit`, `gate`, `wave`, fail-closed, canonical); append rows to `doc/i18n/GLOSSARY.md` only if a new SDD term is introduced (same PR)
