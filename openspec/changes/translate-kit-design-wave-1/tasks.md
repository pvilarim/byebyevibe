...
- [ ] 1.2 Soft-check hub design-wave-1 apply status and avoid concurrent kit-template applies
...
- [ ] 3.2 Run per-wave i18n verification on the exact kit design file list
