...
- [ ] 1.1 Confirm glossary covers terms needed for this wave (`evaluation`, Adopted/Deferred, Session Handoff, wave, glossary); append rows to `doc/i18n/GLOSSARY.md` only if a new SDD term is introduced (same PR)
...
- [ ] 3.1 Run per-wave i18n verification on the exact methodology file path
