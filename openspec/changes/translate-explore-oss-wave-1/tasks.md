...
- [ ] 1.1 Confirm glossary covers terms needed for this wave (`evaluation`, Adopted/Deferred, manual fix, wave, Session Handoff); append rows to `doc/i18n/GLOSSARY.md` only if a new SDD term is introduced (same PR)
