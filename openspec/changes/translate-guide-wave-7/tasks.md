...
- [x] 2.1 Rewrite lines **1047–1278** (§3–§4 task classification + master tool table) Portuguese prose → glossary-canonical English; do not edit lines outside the slice
