# Design — translate-design-wave-4

## Context

- Layer-1 policy: `sdd-docs-language` / `doc/i18n/*`.
- Target: `doc/design/001-pipeline-open-design-shadcn-impeccable.md` lines **326–592** (§4–§13 shadcn phase through history, ~267 LOC).
...
3. Validate: `OPENSPEC_TELEMETRY=0 npx --yes @fission-ai/openspec@1.3.1 validate translate-design-wave-4 --strict`.
