...
- **Guia de instalação SDD:** `doc/sistema-sdd-pedro.md` **v1.3.2** — instalação §2 + `sdd-kit/install.sh`; actualização §2.9 + `sdd-kit/upgrade.sh`; módulo UI §2.11 + `sdd-kit/install-ui-module.sh`
- **Install kit:** `sdd-kit/` (MANIFEST v1.3.2) — payloads versionados para C1/C2/C1-UI
