...
- `AGENTS.md` é o entry point universal (formato [agents.md](https://agents.md/), guia v1.1.2)
...
- **Guia de instalação SDD:** `doc/sistema-sdd-pedro.md` **v1.1.2** — usar para instalar o sistema noutros repos
