...
### Requirement: translate-guide-wave-6 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 840–1046) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-7 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 1047–1278) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-8 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 1279–1457) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-9 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 1458–1619) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-10 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 1620–1973) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-11 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 1974–2139) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-12 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 2140–2503) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-13 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 2504–2729) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
...
### Requirement: translate-guide-wave-14 target surface is English

The following path MUST be written in English after substitution: `doc/sistema-sdd-pedro.md`. Residual Portuguese prose in the substituted slice (lines 2730–2847) is FORBIDDEN after apply. Dual-file siblings such as `*.en.md` or `*-pt.md` MUST NOT be introduced. Freeze-list tokens (paths, change-ids, `/opsx:*`, package pins, URLs, fenced shell, profile labels, and brand/tool names) MUST remain unaltered aside from intentional non-i18n fixes.
