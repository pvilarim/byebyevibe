# sdd-skill-guidance Specification

## Purpose

Normative requirements for novice-facing skill lifecycle guidance: when-to-create pedagogy in the day-1 doc, agent-side conversational detection signals, standard three-part suggestion message with anti-noise cap, archive-time repetition question, creation hygiene (search-before-create, description diet, task-based naming, staleness marker), dual Claude Code + Cursor delivery, and v2 monitoring scope recorded as deferred non-goals.
